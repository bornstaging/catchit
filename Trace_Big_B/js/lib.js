...
function drawletter(letter) {
  ...
  if (OSName == "Mac/iOS") {
    $(".bGif")
      .css("left", centerx + 23 + "px")
      .css("top", centery - fontMeasurement.height + 55 + "px")
      .css("width", cx.measureText(letter).width - 45 + "px");
  } else if (OSName == "Linux") {
    $(".bGif")
      .css("left", centerx + 20 + "px")
      .css("top", centery - fontMeasurement.height + 47 + "px")
      .css("width", cx.measureText(letter).width - 35 + "px");
  } else {
    $(".bGif")
      .css("left", centerx + 15 + "px")
      .css("top", centery - fontMeasurement.height + 19 + "px")
      .css("width", cx.measureText(letter).width - 30 + "px");
  }
}
